...
This project is a part of coursework of Data Mining for Credit Scoring from University of Southampton. **Data is not cleaned well** since this version is a fast one, the completed will be **updated**.
